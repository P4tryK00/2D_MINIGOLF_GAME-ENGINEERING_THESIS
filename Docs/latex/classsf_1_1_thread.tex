\doxysection{Dokumentacja klasy sf\+::Thread}
...
Diagram dziedziczenia dla sf\+::Thread\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=169pt]{classsf_1_1_thread__inherit__graph}
\end{center}
\end{figure}


Diagram współpracy dla sf\+::Thread\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=550pt]{classsf_1_1_thread__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classsf_1_1priv_1_1_thread_impl}{priv\+::\+Thread\+Impl}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{classsf_1_1_thread_ac6d215423182b4e8c18db34ea6ae51fc}{m\+\_\+impl}}
\begin{DoxyCompactList}\small\item\em OS-\/specific implementation of the thread. \end{DoxyCompactList}\item 
\mbox{\hyperlink{structpriv_1_1_thread_func}{priv\+::\+Thread\+Func}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{classsf_1_1_thread_a8326ed80dfffb6a0d92560a86a665b4d}{m\+\_\+entry\+Point}}
...
\Hypertarget{classsf_1_1_thread_a4cc65399bbb111cf8132537783b8e96c}\label{classsf_1_1_thread_a4cc65399bbb111cf8132537783b8e96c} 
...
\hline
\end{DoxyParams}
\Hypertarget{classsf_1_1_thread_af77942fc1730af7c31bc4c3a913a9c1d}\label{classsf_1_1_thread_af77942fc1730af7c31bc4c3a913a9c1d} 
...
This destructor calls \doxylink{classsf_1_1_thread_a724b1f94c2d54f84280f2f78bde95fa0}{wait()}, so that the internal thread cannot survive after its \doxylink{classsf_1_1_thread}{sf\+::\+Thread} instance is destroyed. Oto graf wywołań dla tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsf_1_1_thread_af77942fc1730af7c31bc4c3a913a9c1d_cgraph}
\end{center}
\end{figure}
...
\Hypertarget{classsf_1_1_thread_a74f75a9e86e1eb47479496314048b5f6}\label{classsf_1_1_thread_a74f75a9e86e1eb47479496314048b5f6} 
...
This function starts the entry point passed to the thread\textquotesingle{}s constructor, and returns immediately. After this function returns, the thread\textquotesingle{}s function is running in parallel to the calling code. Oto graf wywołań dla tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsf_1_1_thread_a74f75a9e86e1eb47479496314048b5f6_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsf_1_1_thread_a74f75a9e86e1eb47479496314048b5f6_icgraph}
\end{center}
\end{figure}
\Hypertarget{classsf_1_1_thread_a593508379bd38e0b42ebf9f5a7e2829c}\label{classsf_1_1_thread_a593508379bd38e0b42ebf9f5a7e2829c} 
...
This function is called by the thread implementation. Oto graf wywołań dla tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=305pt]{classsf_1_1_thread_a593508379bd38e0b42ebf9f5a7e2829c_cgraph}
\end{center}
\end{figure}
Oto graf wywoływań tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsf_1_1_thread_a593508379bd38e0b42ebf9f5a7e2829c_icgraph}
\end{center}
\end{figure}
\Hypertarget{classsf_1_1_thread_ad6b205d4f1ce38b8d44bba0f5501477c}\label{classsf_1_1_thread_ad6b205d4f1ce38b8d44bba0f5501477c} 
...
This function immediately stops the thread, without waiting for its function to finish. Terminating a thread with this function is not safe, and can lead to local variables not being destroyed on some operating systems. You should rather try to make the thread function terminate by itself. Oto graf wywołań dla tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=324pt]{classsf_1_1_thread_ad6b205d4f1ce38b8d44bba0f5501477c_cgraph}
\end{center}
\end{figure}
\Hypertarget{classsf_1_1_thread_a724b1f94c2d54f84280f2f78bde95fa0}\label{classsf_1_1_thread_a724b1f94c2d54f84280f2f78bde95fa0} 
...
This function will block the execution until the thread\textquotesingle{}s function ends. Warning\+: if the thread function never ends, the calling thread will block forever. If this function is called from its owner thread, it returns without doing anything. Oto graf wywołań dla tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=301pt]{classsf_1_1_thread_a724b1f94c2d54f84280f2f78bde95fa0_cgraph}
\end{center}
\end{figure}
Oto graf wywoływań tej funkcji\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsf_1_1_thread_a724b1f94c2d54f84280f2f78bde95fa0_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily friend class \mbox{\hyperlink{classsf_1_1priv_1_1_thread_impl}{priv\+::\+Thread\+Impl}}\hspace{0.3cm}{\ttfamily [friend]}}



\doxysubsection{Dokumentacja atrybutów składowych}
\Hypertarget{classsf_1_1_thread_a8326ed80dfffb6a0d92560a86a665b4d}\label{classsf_1_1_thread_a8326ed80dfffb6a0d92560a86a665b4d} 
...
{\footnotesize\ttfamily \mbox{\hyperlink{structpriv_1_1_thread_func}{priv\+::\+Thread\+Func}}\texorpdfstring{$\ast$}{*} sf\+::\+Thread\+::m\+\_\+entry\+Point\hspace{0.3cm}{\ttfamily [private]}}



Abstraction of the function to run. 

\Hypertarget{classsf_1_1_thread_ac6d215423182b4e8c18db34ea6ae51fc}\label{classsf_1_1_thread_ac6d215423182b4e8c18db34ea6ae51fc} 
...
{\footnotesize\ttfamily \mbox{\hyperlink{classsf_1_1priv_1_1_thread_impl}{priv\+::\+Thread\+Impl}}\texorpdfstring{$\ast$}{*} sf\+::\+Thread\+::m\+\_\+impl\hspace{0.3cm}{\ttfamily [private]}}
...
\item 
cmake-\/build-\/debug/\+\_\+deps/sfml-\/src/include/\+SFML/\+System/\mbox{\hyperlink{_thread_8hpp}{Thread.\+hpp}}\item 
cmake-\/build-\/debug/\+\_\+deps/sfml-\/src/include/\+SFML/\+System/\mbox{\hyperlink{_thread_8inl}{Thread.\+inl}}\item 
cmake-\/build-\/debug/\+\_\+deps/sfml-\/src/src/\+SFML/\+System/\mbox{\hyperlink{_thread_8cpp}{Thread.\+cpp}}\end{DoxyCompactItemize}
